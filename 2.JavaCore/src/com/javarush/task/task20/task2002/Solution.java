        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            if (this.users.size() > 0){
                for (User current :this.users){
                    ...
                    sd.append(current.getFirstName());
                    sd.append("/");
                    sd.append(current.getLastName());
                    sd.append("/");
                    sd.append(current.getBirthDate().getTime());
                    sd.append("/");
                    sd.append(current.isMale());
                    sd.append("/");
                    sd.append(current.getCountry());
                    
                    printWriter.println(sd.toString());
                }
            }
            printWriter.close();
        }
